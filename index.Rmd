...
# Introduction
    ...
    The surgent growth of gentrification across cities in the United States since the 1970s has received increasing attention from American society. Gentrification has significantly changed  the neighborhood socioeconomic characteristics. In addition, this city redevelopment trend has nearly coincided with the U.S. crime changes in the late 20th century — the crime rates in major U.S. cities increased from the 1960s to 1980s, and they experienced a considerable drop during the 1990s (Barton 2016). Considering the widespread spatial phenomenon and the growing attention on crime occurrences in the United States, it is essential to explore the potential association between these two compelling trends.
